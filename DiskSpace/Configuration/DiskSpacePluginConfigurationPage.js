define(["require", "loading", "dialogHelper", "mainTabsManager", "formDialogStyle", "emby-checkbox", "emby-select", "emby-toggle"],
    function(require, loading, dialogHelper,  mainTabsManager) {
        ...
        //        dlg.classList.add("background-theme-a");
        //        dlg.classList.add("colorChooser");
        //        dlg.style = "max-width:45%; max-height:42em";
        ...
        //        html += '<div class="inputContainer">';
        //        html += '<label class="inputLabel inputLabelUnfocused" for="driveChartCutoutPercentage">Drive chart cutout percentage</label>';
        //        html += '<input type="number" min="20" max="99" name="driveChartCutoutPercentage" id="driveChartCutoutPercentage" label="Drive chart cutout percentage" class="emby-input" style="height:2em"> ';
        //        html += '</div>'
        ...
        //            dlg.querySelector('#driveChartCutoutPercentage').value     = config.ChartCutoutPercentage ?? 40;
        ...
        //        dlg.querySelector('#driveChartCutoutPercentage').addEventListener('change', () => {
        //            ApiClient.getPluginConfiguration(pluginId).then((config) => {
        //                config.ChartCutoutPercentage = dlg.querySelector('#driveChartCutoutPercentage').value;
        //                ApiClient.updatePluginConfiguration(pluginId, config).then(() => { });
        //            });
        //        })
        ...
        //        dlg.querySelector('#usedSpaceOutlineColor').addEventListener('input',
        //            () => {
